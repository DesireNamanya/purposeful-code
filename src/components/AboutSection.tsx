      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="font-sans text-muted-foreground text-lg leading-relaxed">
            Coding With God is a purpose-driven technology company building software that solves real-world problems while honoring values of integrity, stewardship, and service.
          </p>
        </div>
